...
foreach ($st in $stories) {
  ...
  $labels = @("type:story",$priorityLabel,$sprintLabel) + $st.a
...
"@
  ...
  $u = New-Issue -Title $st.t -Body $body -Labels $labels
